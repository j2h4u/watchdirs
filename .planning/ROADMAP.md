...
**Success Criteria** (what must be TRUE):
  1. Agent can run `watchdirs collect` for configured roots and get a timestamped snapshot with collection status, timing, root path, notes, and fatal error metadata.
...
|-------|----------------|--------|-----------|
| 1. Trusted Snapshot Collection | 0/TBD | Not started | - |
