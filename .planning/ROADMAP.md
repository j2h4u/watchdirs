...
- [x] 03.2-01-PLAN.md — Collapse policy config and explicit SQLite schema version 4 migration

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 03.2-02-PLAN.md — Scanner shallowest-boundary collapse preserving recursive aggregates

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 03.2-03-PLAN.md — Reporting metadata for collapsed rows and top-child breadcrumbs
- [x] 03.2-04-PLAN.md — No-collapse regression fence plus cardinality and SQLite-size proof
...
- [x] 04-01-PLAN.md - Shared fail-fast writer lock for mutating operations
...
- [x] 04-03-PLAN.md - Explicit locked SQLite vacuum maintenance command
