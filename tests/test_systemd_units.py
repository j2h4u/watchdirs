...
EXPECTED_UNIT_TEXT = {
    "watchdirs-collect.service": (
        ...
        "ExecStart=/usr/local/bin/watchdirs collect --config /etc/watchdirs/watchdirs.toml --json --verbose",
    ...
    "watchdirs-prune.service": (
        ...
        "Environment=PYTHONUNBUFFERED=1",
        "Environment=PYTHONDONTWRITEBYTECODE=1",
        "ExecStart=/usr/local/bin/watchdirs prune --hourly-days 3 --daily-days 90 --json",
        "StateDirectory=watchdirs",
        "ConfigurationDirectory=watchdirs",
        "UMask=0077",
        "Nice=19",
    ...
    "watchdirs-vacuum.service": (
        ...
        "Environment=PYTHONUNBUFFERED=1",
        "Environment=PYTHONDONTWRITEBYTECODE=1",
        "ExecStart=/usr/local/bin/watchdirs vacuum --json",
        "StateDirectory=watchdirs",
        "ConfigurationDirectory=watchdirs",
        "UMask=0077",
        "Nice=19",
